...
\begin{center}
    ...
    \small +1-224-307-3331 $|$ \href{mailto:chenkai.weng@asu.edu}{chenkai.weng@asu.edu} $|$ 
...
\begin{enumerate}[leftmargin=0.20in]
  \item
    {\textbf{\small Committed Vector Oblivious Linear Evaluation and Its Applications}} \\
		{\small Yunqing Sun, Hanlin Liu, Kang Yang, Yu Yu, Xiao Wang, Chenkai Weng \vspace{-2pt}}
		{\small ACM Conference on Computer and Communications Security (CCS), 2025}
  \item
    {\textbf{\small On Large Language Model Continual Unlearning}} \\
		{\small Chongyang Gao, Lixu Wang, Kaize Ding, Chenkai Weng, Xiao Wang, Qi Zhu\vspace{-2pt}}
		{\small International Conference on Learning Representations (ICLR), 2025}
  \item
...
\begin{enumerate}[leftmargin=0.20in]
  \item 
    {\textbf{\small Efficient Mixed-Mode Oblivious RAMs}} \\
		{\small Wenhao Zhang, Xiao Wang, Chenkai Weng \vspace{-2pt}} \\
  \item 
    {\textbf{\small AES-based CCR Hash with High Security and Its Application to Zero-Knowledge Proofs}} \\
		{\small Hongrui Cui, Chun Guo, Xiao Wang, Chenkai Weng, Kang Yang, Yu Yu \vspace{-2pt}} \\
  \item 
    {\textbf{\small Collusion Resistant DNS With Private Information Retrieval}} \\
		{\small Yunming Xiao, Peizhi Liu, Ruijie Yu, Chenkai Weng, Matteo Varvello, Aleksandar Kuzmanovic \vspace{-2pt}} \\
\end{enumerate}
...
\section{Teaching}
  \resumeSubHeadingListStart
     \resumeSubheading
      {Lecturer}{Tempe, AZ}
      {Arizona State University}{Aug. 2025 -- Dec. 2025}
      \resumeItemListStart
        \resumeItem{CSE 494: Introduction to Cryptography}
      \resumeItemListEnd
     ...
     \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{CSE 539: Applied Cryptography}
      \resumeItemListEnd
...
\begin{enumerate}[leftmargin=0.15in, label={}]
  \item \textbf{Program committee member}: AsiaCCS 2024, CCS 2024-25, Usenix Security 2025-26, Euro S\&P 2025.

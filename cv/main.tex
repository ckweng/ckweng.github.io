...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Interactive zero-knowledge protocols for arbitrary boolean/arithmetic circuits and polynomials.}
        \resumeItem{Correlated oblivious transfer based on vector oblivious linear evaluation.}
        \resumeItem{Concrete security of the garbled circuit protocol.}
        \resumeItem{Implementation and evaluation of MPC/ZK applications.}
      \resumeItemListEnd

...
\begin{enumerate}[leftmargin=0.20in]
  ...
  \item
    $\ast${\textbf{\small SUPERPACK: Dishonest Majority MPC with Constant Online Communication}} \\
  ...
  \item
    $\ast${\textbf{\small Constant-Overhead Zero-Knowledge for RAM Programs}} \\
  ...
  \item
          $\ast${\textbf{\small Better Concrete Security for Half-Gates Garbling (in the Multi-Instance Setting)}} \\
